...
class BodyCodegen implements Kissaki_CodeTag
{
	...
	private void generateGenerator()
	{
		...
		addScriptRuntimeInvoke2(CODE_CREATEFUNCTIONACTUIVATION,
...
//			}
		...
		if (fnCurrent != null) {
			...
			cfw.addALoad(variableObjectLocal);
			addScriptRuntimeInvoke2(CODE_ENTERFUNCTIONACTUIVATION,
					"(Lorg/mozilla/javascript/Context;"
					+"Lorg/mozilla/javascript/Scriptable;"
					+")V",
					nullNode);
			...
			addScriptRuntimeInvoke2(CODE_INITSCRIPT,
					"(Lorg/mozilla/javascript/NativeFunction;"
					+"Lorg/mozilla/javascript/Scriptable;"
					+"Lorg/mozilla/javascript/Context;"
					+"Lorg/mozilla/javascript/Scriptable;"
	...
	private void generateStatement(Node node)
	{
		...
		case Token.ENUM_INIT_ARRAY:
			...
			addScriptRuntimeInvoke2(CODE_ENUMINIT,
					"(Ljava/lang/Object;"
					+"Lorg/mozilla/javascript/Context;"
					+"I"
					+")Ljava/lang/Object;",
	...
	private void generateExpression(Node node, Node parent)
	{
		...
		case Token.ENUM_ID: {
			...
			if (type == Token.ENUM_NEXT) {
				...
				cfw.addALoad(contextLocal);
				addScriptRuntimeInvoke2(CODE_ENUMID,
						"(Ljava/lang/Object;"
						+"Lorg/mozilla/javascript/Context;"
						+")Ljava/lang/Object;",
						node);
		...
		case Token.BITNOT:
			generateExpression(child, node);
			addScriptRuntimeInvoke2(CODE_TOINT32, "(Ljava/lang/Object;)I",
					node);
		...
		case Token.TYPEOF:
			generateExpression(child, node);
			addScriptRuntimeInvoke2(CODE_TYPEOF,
					"(Ljava/lang/Object;"
					+")Ljava/lang/String;",
					node);
			break;
		...
		case Token.AND: {
			generateExpression(child, node);
			cfw.add(ByteCode.DUP);
			addScriptRuntimeInvoke2(CODE_TOBOOLEAN,
					"(Ljava/lang/Object;)Z",
					node);
			int falseTarget = cfw.acquireLabel();
			if (type == Token.AND)
		...
		case Token.ADD: {
			...
			default:
				if (child.getType() == Token.STRING) {
					addScriptRuntimeInvoke2(CODE_ADD,
							"(Ljava/lang/String;"
							+"Ljava/lang/Object;"
							+")Ljava/lang/String;",
							node);
		...
		case Token.DEL_REF:
			generateExpression(child, node);
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke2(CODE_REFDEL,
					"(Lorg/mozilla/javascript/Ref;"
					+"Lorg/mozilla/javascript/Context;"
					+")Ljava/lang/Object;",
					node);
		...
		case Token.DELPROP:
			...
			generateExpression(child, node);
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke2(CODE_DELETE,
					"(Ljava/lang/Object;"
					+"Ljava/lang/Object;"
					+"Lorg/mozilla/javascript/Context;"
					+")Ljava/lang/Object;",
		...
		case Token.REF_NS_NAME:
		{
			...
			addScriptRuntimeInvoke2(methodName, signature,
					node);
		}
		break;
		...
		case Token.ESCXMLATTR:
			generateExpression(child, node);
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke2(CODE_ESCAPEATTRIBUTEVALUE,
					"(Ljava/lang/Object;"
					+"Lorg/mozilla/javascript/Context;"
					+")Ljava/lang/String;",
					node);
		...
		case Token.ESCXMLTEXT:
			generateExpression(child, node);
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke2(CODE_ESCAPETEXTVALUE,
					"(Ljava/lang/Object;"
					+"Lorg/mozilla/javascript/Context;"
					+")Ljava/lang/String;",
					node);
		...
		case Token.DEFAULTNAMESPACE:
			generateExpression(child, node);
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke2(CODE_SETDEFAULTNAMESPACE,
					"(Ljava/lang/Object;"
					+"Lorg/mozilla/javascript/Context;"
					+")Ljava/lang/Object;",
					node);
			...
			int trueLabel, int falseLabel)
	{
		...
		default:
			...
			addScriptRuntimeInvoke2(CODE_TOBOOLEAN, "(Ljava/lang/Object;)Z",
					node);
	...
	private void visitObjectLiteral(Node node, Node child)
	{
		...
		for (int i = 0; i != count; ++i) {
			...
			if (id instanceof String) {
				...
				addScriptRuntimeInvoke2(CODE_WRAPINT, "(I)Ljava/lang/Integer;",
						node);
			}
			cfw.add(ByteCode.AASTORE);
		}
		...
		cfw.addALoad(contextLocal);
		cfw.addALoad(variableObjectLocal);
		addScriptRuntimeInvoke2(CODE_NEWOBJECTLITERAL,
				"([Ljava/lang/Object;"
				+"[Ljava/lang/Object;"
				+"[I"
				   +"Lorg/mozilla/javascript/Context;"
...
Else pass the JS object in the aReg and 0.0 in the dReg.
	...
	private void visitSwitch(Node.Jump switchNode, Node child)
	{
		...
		caseNode = (Node.Jump)caseNode.getNext())
		{
			...
			addScriptRuntimeInvoke2(CODE_SHALLOWEQ,
					"(Ljava/lang/Object;"
					+"Ljava/lang/Object;"
					+")Z",
					nullNode);
	...
	private void visitTypeofname(Node node)
	{
		...
		cfw.addALoad(variableObjectLocal);
		cfw.addPush(node.getString());
		addScriptRuntimeInvoke2(CODE_TYPEOFNAME,
				"(Lorg/mozilla/javascript/Scriptable;"
				+"Ljava/lang/String;"
				+")Ljava/lang/String;",
				node);
	...
	private void visitIncDec(Node node)
	{
		...
		case Token.NAME:
			...
			addScriptRuntimeInvoke2(CODE_NAMEINCRDECR,
					"(Lorg/mozilla/javascript/Scriptable;"
					+"Ljava/lang/String;"
					+"Lorg/mozilla/javascript/Context;"
					+"I)Ljava/lang/Object;",
		...
		case Token.GETPROP: {
			...
			cfw.addALoad(contextLocal);
			cfw.addPush(incrDecrMask);
			addScriptRuntimeInvoke2(CODE_PROPINCRDECR,
					"(Ljava/lang/Object;"
					+"Ljava/lang/String;"
					+"Lorg/mozilla/javascript/Context;"
					+"I)Ljava/lang/Object;",
		...
		case Token.GETELEM: {
			...
			if (elemChild.getNext().getIntProp(Node.ISNUMBER_PROP, -1) != -1) {
				...
				addScriptRuntimeInvoke2(CODE_ELEMINCRDECR,
						"(Ljava/lang/Object;"
						+"Ljava/lang/Object;"
						+"Lorg/mozilla/javascript/Context;"
						+"I"
	...
	private void visitBitOp(Node node, int type, Node child)
	{
		...
		if (type == Token.URSH) {
			addScriptRuntimeInvoke2(CODE_TOUINT32, "(Ljava/lang/Object;)J",
					node);
			generateExpression(child.getNext(), node);
			addScriptRuntimeInvoke2(CODE_TOINT32, "(Ljava/lang/Object;)I",
					node);
		...
		if (childNumberFlag == -1) {
			...
			addScriptRuntimeInvoke2(CODE_TOINT32, "(D)I",
					node);
			generateExpression(child.getNext(), node);
			addScriptRuntimeInvoke2(CODE_TOINT32, "(D)I",
					node);
			...
			int trueGOTO, int falseGOTO)
	{
		...
		if (childNumberFlag != -1) {
			...
			addScriptRuntimeInvoke2(routine,
					"(Ljava/lang/Object;"
					+"Ljava/lang/Object;"
					+")Z",
					node);
	...
	private void visitDotQuery(Node node, Node child)
	{
		...
		generateExpression(child, node);
		cfw.addALoad(variableObjectLocal);
		addScriptRuntimeInvoke2(CODE_ENTERDOTQUERY,
				"(Ljava/lang/Object;"
				+"Lorg/mozilla/javascript/Scriptable;"
				+")Lorg/mozilla/javascript/Scriptable;",
				node);
		...
		addScriptRuntimeInvoke2(CODE_TOBOOLEAN, "(Ljava/lang/Object;)Z",
				node);
		cfw.addALoad(variableObjectLocal);
		addScriptRuntimeInvoke2(CODE_UPDATEDOTQUERY,
				"(Z"
				+"Lorg/mozilla/javascript/Scriptable;"
				+")Ljava/lang/Object;",
				node);
		...
		cfw.addALoad(variableObjectLocal);
		addScriptRuntimeInvoke2(CODE_LEAVEDOTQUERY,
				"(Lorg/mozilla/javascript/Scriptable;"
				+")Lorg/mozilla/javascript/Scriptable;",
				node);
		cfw.addAStore(variableObjectLocal);
	 ...
	 * @param node
	 */
	private void addScriptRuntimeInvoke2(String methodName, String methodSignature, Node node){
...
//			scopeName = scopeNode.getFunctionName();
//			debug.trace("scopeName_"+scopeName);
//		} ca tch (Exception e) {
//			debug.trace("scopeName_"+"");
//		}
